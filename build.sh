...
FetchWebDev() {
  curl -L https://codeload.github.com/flt6/web-dist-bak/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/flt6/alist-web-bak/releases/latest/download/dist.tar.gz -o dist.tar.gz
